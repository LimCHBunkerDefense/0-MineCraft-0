...
void cAnimalLeftLeg::Setup()
{
	...
	{
		m_vecVertex[0].t.x = (float)2 / 16;	m_vecVertex[0].t.y = (float)13 / 16;
		m_vecVertex[1].t.x = (float)2 / 16;	m_vecVertex[1].t.y = (float)10 / 16;
		m_vecVertex[2].t.x = (float)1 / 16;	m_vecVertex[2].t.y = (float)10 / 16;	 //¾Õ¸é À­»ï°¢ 
																				 //0,1,2

		m_vecVertex[3].t.x = (float)2 / 16;	m_vecVertex[3].t.y = (float)13 / 16;
		m_vecVertex[4].t.x = (float)1 / 16;	m_vecVertex[4].t.y = (float)10 / 16;
		m_vecVertex[5].t.x = (float)1 / 16;	m_vecVertex[5].t.y = (float)13 / 16;	 //¾Õ¸é ¾Æ·§»ï°¢
																				 //0,2,3

		m_vecVertex[6].t.x = (float)3 / 16;	m_vecVertex[6].t.y = (float)13 / 16;
		m_vecVertex[7].t.x = (float)4 / 16;	m_vecVertex[7].t.y = (float)10 / 16;
		m_vecVertex[8].t.x = (float)3 / 16;	m_vecVertex[8].t.y = (float)10 / 16;	 //µÞ¸é À­»ï°¢
																				 //4,6,5
		m_vecVertex[9].t.x = (float)3 / 16;	m_vecVertex[9].t.y = (float)13 / 16;
		m_vecVertex[10].t.x = (float)4 / 16; m_vecVertex[10].t.y = (float)13 / 16;
		m_vecVertex[11].t.x = (float)4 / 16; m_vecVertex[11].t.y = (float)10 / 16;	 //µÞ¸é ¾Æ·§»ï°¢
																				 //4,7,6
		...
		m_vecVertex[30].t.x = (float)3 / 16;	m_vecVertex[30].t.y = (float)10 / 16;
		m_vecVertex[31].t.x = (float)3 / 16;	m_vecVertex[31].t.y = (float)8 / 16;
		m_vecVertex[32].t.x = (float)2 / 16;	m_vecVertex[32].t.y = (float)8 / 16;	 //¾Æ·§¸é À­»ï°¢
																				 //4,0,3

		m_vecVertex[33].t.x = (float)3 / 16;	m_vecVertex[33].t.y = (float)10 / 16;
		m_vecVertex[34].t.x = (float)2 / 16;	m_vecVertex[34].t.y = (float)8 / 16;
		m_vecVertex[35].t.x = (float)2/ 16;	    m_vecVertex[35].t.y = (float)10 / 16;	 //¾Æ·§¸é ¾Æ·§»ï°¢
